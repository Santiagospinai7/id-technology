      ...
      <div className="grid grid-cols-1 md:grid-cols-10 gap-10 mb-20">
        ...
        <div className='bg-blue-200 flex flex-col md:col-span-7'>
          ...
          <div className='flex h-full'>
            ...
            <div className='bg-blue-300 w-1/3'>
              <div className="flex justify-center items-center h-full">
                <img src={chooseUs1} alt="Ecogernos 1" className="max-h-full" />
              </div>
            </div>
            {/* Right Container */}
            <div className='bg-blue-400 flex flex-col justify-center w-2/3 p-5'>
          ...
          <div className='flex h-full'>
            ...
            <div className='bg-blue-300 w-1/3'>
              <div className="flex justify-center items-center h-full">
                <img src={chooseUs3} alt="Ecogernos 1" className="max-h-full" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='bg-red-100 col-span-full md:col-span-3'>
          ...
          <div className='bg-blue-300 w-full md:w-auto mb-4 md:mb-0'>
            <div className="flex justify-center items-center h-full">
              <img src={chooseUs2} alt="Ecogernos 1" className="max-h-full" />
            </div>
          </div>
          {/* Bottom Container */}
