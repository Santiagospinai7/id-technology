...
const ChooseUs = () => {
  let content = (
    <StyledChooseUs className='my-28 text-center'>
      ...
      <div className="grid ms:grid-cols-1 md:grid-flow-col gap-10 mb-20">
        <div className='bg-blue-100 grid gap-5 ms:grid-cols-1 md:col-span-9 md:w-9/10'>
          <div className='bg-blue-200 grid grid-flow-col items-center'>
