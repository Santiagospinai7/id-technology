    ...
    <>
      <div className='flex flex-col md:flex-row my-20 '>
        ...
        <div className='w-full md:w-1/2 flex flex-col justify-center items-center md:items-start p-4 mt-4 md:mt-0'>
          ...
          <button className='bg-green-200 hover:bg-green-300 text-white px-4 py-2 rounded-3xl mt-7 text-sm transition duration-300 transform hover:scale-105 hover:shadow-lg'>
